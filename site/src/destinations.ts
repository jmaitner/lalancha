...
export const destinations: Destination[] = [
  ...
  },
  {
    ...
    description:
      'Glide through downtown on the Chicago River for an up-close architecture cruise on calm, flat water, making it the most family-friendly way to see the city aboard Quarters.',
    intro:
